...
const breakingNewsUrl = `${apiBaseUrl}/top-headlines?country=tr&apiKey=${newsApiKey}`;
const recommendedNewsUrl = `${apiBaseUrl}/top-headlines?country=tr&category=business&apiKey=${newsApiKey}`;

const discoverNewsUrl = (discover) =>
  `${apiBaseUrl}/top-headlines?country=tr&category=${discover}&apiKey=${newsApiKey}`;
