...
import { db, auth, app, storage } from "../screens/firebaseConfig";
      ...
      uploadTask.on(
        ...
        async () => {
          try {
            ...
            // Haberi Firestore'a kaydet
            const newsRef = doc(db, "news", `${Date.now()}`);
            ...
            Alert.alert("Haber kaydedilirken hata:", error.message);
          }
        }
      );
    } catch (error) {
